...
<script>
function f5_1() {
  document.getElementById("5_1").innerHTML = "c";
}
</script>
...
**a)** Al pedirnos el histograma, tenemos que agrupar los datos en intervalos. Vemos que el valor mínimo es 77 y el máximo 110. Así, vamos aconsiderar intervalos de amplitud 5 comenzando por el intervalos $[75,80)$. En el último intervalos, incluimos al extremo superior $110$:

<img src="img/2_6.png" width="669" />

Gráfico obtenido siguiendo esta [Práctica del Curso de Bioestadística](https://1fjmanzano.github.io/bioestadistica/histogramas.html#histogramas-con-excel-pr%C3%A1cticas)

**b)** Obtenemos el boxplot (diagrama de cajas y bigotes) con Excel©

<img src="img/2_7.png" width="357" />
